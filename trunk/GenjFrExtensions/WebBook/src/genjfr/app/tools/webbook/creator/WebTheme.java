...
public class WebTheme extends WebSection {
    ...
    public void create() {
        ...
        // create style file
        File file = new File(wh.getDir(), css);
        wb.log.write(trs("exporting", new String[]{file.getName(), wh.getDir().toString()}));
   ...
   /**
    ...
    public void createIcons(File dir) {
        ...
        try {
            wh.copy(genjImagesDir + File.separator + "m.gif", dir.getAbsolutePath() + File.separator + "m.gif");
            wh.copy(genjImagesDir + File.separator + "f.gif", dir.getAbsolutePath() + File.separator + "f.gif");
            wh.copy(genjImagesDir + File.separator + "u.gif", dir.getAbsolutePath() + File.separator + "u.gif");
            wh.copy(genjImagesDir + File.separator + "s.gif", dir.getAbsolutePath() + File.separator + "s.gif");
            wh.copy(genjImagesDir + File.separator + "p.gif", dir.getAbsolutePath() + File.separator + "p.gif");
            wh.copy(genjImagesDir + File.separator + "t.gif", dir.getAbsolutePath() + File.separator + "t.gif");
            wh.copy(genjImagesDir + File.separator + "h.gif", dir.getAbsolutePath() + File.separator + "h.gif");
            wh.copy(genjImagesDir + File.separator + "b.gif", dir.getAbsolutePath() + File.separator + "b.gif");
            wh.copy(genjImagesDir + File.separator + "n.gif", dir.getAbsolutePath() + File.separator + "n.gif");
            wh.copy(genjImagesDir + File.separator + "e.gif", dir.getAbsolutePath() + File.separator + "e.gif");
            wh.copy(genjImagesDir + File.separator + "src.gif", dir.getAbsolutePath() + File.separator + "src.gif");
            wh.copy(genjImagesDir + File.separator + "downbar.png", dir.getAbsolutePath() + File.separator + "downbar.png");
            wh.copy(genjImagesDir + File.separator + "downleft.png", dir.getAbsolutePath() + File.separator + "downleft.png");
            wh.copy(genjImagesDir + File.separator + "downright.png", dir.getAbsolutePath() + File.separator + "downright.png");
            wh.copy(genjImagesDir + File.separator + "leftbar.png", dir.getAbsolutePath() + File.separator + "leftbar.png");
            wh.copy(genjImagesDir + File.separator + "rightbar.png", dir.getAbsolutePath() + File.separator + "rightbar.png");
            wh.copy(genjImagesDir + File.separator + "upbar.png", dir.getAbsolutePath() + File.separator + "upbar.png");
            wh.copy(genjImagesDir + File.separator + "upleft.png", dir.getAbsolutePath() + File.separator + "upleft.png");
            wh.copy(genjImagesDir + File.separator + "upright.png", dir.getAbsolutePath() + File.separator + "upright.png");
            wh.copy(genjImagesDir + File.separator + "medno.png", dir.getAbsolutePath() + File.separator + "medno.png");
            wh.copy(genjImagesDir + File.separator + "mednopic.png", dir.getAbsolutePath() + File.separator + "mednopic.png");
            wh.copy(genjImagesDir + File.separator + "medpriv.png", dir.getAbsolutePath() + File.separator + "medpriv.png");
            wh.copy(genjImagesDir + File.separator + "map.gif", dir.getAbsolutePath() + File.separator + "map.gif");
            wh.copy(genjImagesDir + File.separator + "mail.gif", dir.getAbsolutePath() + File.separator + "mail.gif");
        } catch (IOException e) {
            //e.printStackTrace();
            wb.log.write(e.toString());
        }
    }

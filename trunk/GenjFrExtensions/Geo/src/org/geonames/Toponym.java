...
public class Toponym {
	 ...
	 */
	public String getAdminName3() throws InsufficientStyleException {
		if (adminName3 == null && style != null
				&& Style.LONG.compareTo(style) > 0) {
			throw new InsufficientStyleException(
					"adminName3 not supported by style " + style.name());
		}
		return adminName3;
	}
	 ...
	 * @return the postcode
	 */
	public String getPostcode() throws InsufficientStyleException {
		if (postcode == null && style != null
				&& Style.LONG.compareTo(style) > 0) {
			throw new InsufficientStyleException(
					"postcode not supported by style " + style.name());
		}
		return postcode;
	}

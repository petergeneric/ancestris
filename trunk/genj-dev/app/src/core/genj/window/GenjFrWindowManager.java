 ...
 */
public class GenjFrWindowManager extends WindowManager {
   ...
   * Constructor
   */
  public GenjFrWindowManager(Registry registry, ImageIcon defaultDialogImage) {
    super(registry);
...
//	    frame.setVisible(true);
  ...
  public Component openWindowImpldis(final String key, String title, ImageIcon image, JComponent content, JMenuBar menu, Rectangle bounds, boolean maximized, final Action onClosing) {
...
//    return null;
   ...
   * @see genj.window.WindowManager#getContent(java.lang.String)
   */
  public JComponent getFrame(String key) {
...
//    return (WindowManager)window2manager.get(window);
    return genj.app.App.genjfrWindowManager;
  }

 ...
 * @author lemovice
 */
@ServiceProvider(position = 308, service = LookAndFeelProvider.class)
public class LnFJtattooMcWin extends LookAndFeelProvider {

    private static final String KEY = "lnf_JtattooMcWin";

...
@NbBundle.Messages({"CTL_CheckDuplicatesAction=Check Duplicate",
"CheckDuplicates.runing=Checking duplicates"})
public final class CheckDuplicatesWizardAction implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if ((context = Utilities.actionsGlobalContext().lookup(Context.class)) != null) {
            ...
            panels.add(new CheckDuplicatesWizardPanel1());
            panels.add(new CheckDuplicatesWizardPanel2());

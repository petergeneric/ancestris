...
public class CommandEvaluator {
     ...
     */
    public static org.openide.util.Task evaluate (final ProviderModel providerModel, String command, ResultsModel model) {
        List<CategoryResult> l = new ArrayList<CategoryResult>();
        String[] commands = parseCommand(providerModel,command);
     ...
     */
    private static boolean getProviderCategories (ProviderModel providerModel, String[] commands, List<Category> result) {
        List<Category> cats = providerModel.getCategories();

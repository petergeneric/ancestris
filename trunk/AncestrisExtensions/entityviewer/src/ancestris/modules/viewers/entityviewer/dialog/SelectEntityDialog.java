 ...
 */
package ancestris.modules.viewers.entityviewer.dialog;

import ancestris.modules.viewers.entityviewer.panels.SelectEntityPanel;
...
public class SelectEntityDialog {
    ...
    String entityTag;
    Gedcom gedcom;
    SelectEntityPanel selectEntityPanel;
    ...
    public Entity getEntity() {
        ...
        if (!selectedEntityID.isEmpty()) {
            ...
            if (selectedEntity != null) {
                selectEntityPanel.setSelectedEntity(selectedEntity);
            }
        }
        
        // let's display the dialog now...
        if (DialogDisplayer.getDefault().notify(notifyDescriptor) == NotifyDescriptor.OK_OPTION) {
            modulePreferences.put("SelectEntityDialog." + gedcom.getName() + "." + entityTag, selectEntityPanel.getSelectedEntity().getId());

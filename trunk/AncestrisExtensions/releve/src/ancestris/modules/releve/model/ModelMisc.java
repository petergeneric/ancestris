...
//    }
    ...
    public BeanField[] getFieldList( int recordIndex ) {
        ...
        BeanField beanField[] = {
            ...
            new BeanField(record, "Divers", ks1),
            ...
            new BeanField(record, "Intervenant 1", ks2),
            ...
            new BeanField(record, "Ex conjoint", null),
            ...
            new BeanField(record, "Intervenant 2", ks5),

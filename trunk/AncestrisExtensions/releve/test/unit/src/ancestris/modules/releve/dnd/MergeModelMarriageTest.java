...
public class MergeModelMarriageTest extends TestCase {
    ...
    public static RecordMarriage createMarriageRecord(String id) {
        ...
        if ( id.equals("M1")) {
            ...
            record.setIndiFather("indifathername", "FATHERLASTNAME", "indifatheroccupation", "indiFatherResidence", "indifathercomment", "false", "70y");
            record.setIndiMother("indimothername", "MOTHERLASTNAME", "indimotheroccupation", "indiMotherResidence", "indimothercomment", "false", "72y");
            ...
            record.setWifeFather("wifefathername", "WIFEFATHERLASTNAME", "wifefatheroccupation", "wiferFatherResidence", "wifefathercomment", "false", "60y");
            record.setWifeMother("wifemothername", "WIFEMOTHERLASTNAME", "wifemotheroccupation", "wifeMotherResidence", "wifemothercomment", "false", "62y");
    ...
    public void testAddMarriage() {
        try {
            ...
            assertEquals("Note mariage",1307, fam.getValue(new TagPath("FAM:MARR:NOTE"),"").length());
    ...
    public void testUpdateMarriageWithoutWife() {
        try {
            ...
            assertEquals("Date mariage",mergeRecord.getEventDate().getValue(), fam.getMarriageDate().getValue());
            assertEquals("Lieu mariage",mergeRecord.getEventPlace(), fam.getValue(new TagPath("FAM:MARR:PLAC"),""));
            assertEquals("Note mariage",793, fam.getValue(new TagPath("FAM:MARR:NOTE"),"").length());

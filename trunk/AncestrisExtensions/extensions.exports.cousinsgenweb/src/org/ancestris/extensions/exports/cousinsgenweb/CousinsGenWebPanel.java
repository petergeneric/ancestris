 ...
 */
package org.ancestris.extensions.exports.cousinsgenweb;
...
public class CousinsGenWebPanel extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (fc.showSaveDialog(null) == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                DirName = fc.getCurrentDirectory().getCanonicalPath();
            } catch (IOException ex) {
                DirName = "";
            }
            // save export directory
            NbPreferences.forModule(CousinsGenWebPanel.class).put("textFieldFileName", DirName);
            textFieldFileName.setText(NbPreferences.forModule(CousinsGenWebPanel.class).get("textFieldFileName", ""));
        }

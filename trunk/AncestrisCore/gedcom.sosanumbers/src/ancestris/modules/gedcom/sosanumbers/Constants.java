...
public interface Constants {
    ...
    final public int MODE_GENERATE = 1;
    final public int MODE_ERASE = 2;
    
    final public int NUMBERING_SOSADABOVILLE = 1;
    final public int NUMBERING_SOSA = 2;
    final public int NUMBERING_DABOVILLE = 3;
    final public int NUMBERING_ALL = 4;

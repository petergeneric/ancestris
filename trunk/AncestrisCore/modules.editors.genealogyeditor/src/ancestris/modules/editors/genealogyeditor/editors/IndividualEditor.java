...
//            add("FACT"); not defined in gedcom xml definition files
    ...
    private void initComponents() {
        ...
        generalPanelLayout.setHorizontalGroup(
            ...
            .addGroup(generalPanelLayout.createSequentialGroup()
                .addComponent(imageBean, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        generalPanelLayout.setVerticalGroup(
            ...
            .addGroup(generalPanelLayout.createSequentialGroup()
                .addGroup(generalPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(imageBean, javax.swing.GroupLayout.PREFERRED_SIZE, 160, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(0, 0, 0))
        );
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(0, 0, 0)
                .addComponent(individualEventEditorPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 753, Short.MAX_VALUE))
        );
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(0, 0, 0)
                .addComponent(individualEventEditorPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 242, Short.MAX_VALUE))
        );
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(individualInformationTabbedPane, javax.swing.GroupLayout.DEFAULT_SIZE, 269, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    protected void setContextImpl(Context context) {
        ...
        if (entity != null && entity instanceof Indi) {
            ...
            namesListPanel.set(mIndividual, namesList);
...
/*        if (individualEvents.isEmpty() == true) {
             ...
             * +1 <<ASSOCIATION_STRUCTURE>>
             */
            associationsListPanel.setAssociationsList(mIndividual, mIndividual.getProperties(PropertyAssociation.class));
             ...
             * +1 <<NOTE_STRUCTURE>>
             */
            noteCitationsListPanel.set(mIndividual, Arrays.asList(mIndividual.getProperties("NOTE")));

            /*
             * +1 <<SOURCE_CITATION>>
             */
            sourceCitationsListPanel.set(mIndividual, Arrays.asList(mIndividual.getProperties("SOUR")));

...
public class DisplayStatsAction extends AbstractAncestrisAction {
     ...
     * Constructor
     */
    public DisplayStatsAction(GedcomCompareTopComponent tstc) {
        this.owner = tstc;
        setImage(new javax.swing.ImageIcon(getClass().getResource("/ancestris/modules/gedcomcompare/resources/connectionstats.png")));

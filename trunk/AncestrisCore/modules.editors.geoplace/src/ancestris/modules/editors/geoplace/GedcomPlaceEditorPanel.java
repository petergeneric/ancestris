...
public class GedcomPlaceEditorPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        gedcomLatitudeLabel.setText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("ancestris/modules/editors/geoplace/Bundle").getString("GedcomPlaceEditorPanel.gedcomLatitudeLabel.text_1"), new Object[] {})); // NOI18N
        ...
        gedcomCountyTextField.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void changedUpdate(DocumentEvent e) {
                if (!updateOnGoing) {
                    mPlaceModified = true;
                    PropertyPlace[] sameChoices = PropertyPlace.getSameChoices(getGedcom(), mPlaceOrder[5], gedcomCountyTextField.getText());
        ...
        gedcomLongitudeLabel.setText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("ancestris/modules/editors/geoplace/Bundle").getString("GedcomPlaceEditorPanel.gedcomLongitudeLabel.text_1"), new Object[] {})); // NOI18N
        ...
        gedcomCityTextField.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void changedUpdate(DocumentEvent e) {
                if (!updateOnGoing) {
                    mPlaceModified = true;
                    PropertyPlace[] sameChoices = PropertyPlace.getSameChoices(getGedcom(), mPlaceOrder[2], gedcomCityTextField.getText());
                    if (sameChoices.length > 0) {
        ...
        gedcomStateTextField.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void changedUpdate(DocumentEvent e) {
                if (!updateOnGoing) {
                    mPlaceModified = true;
                    PropertyPlace[] sameChoices = PropertyPlace.getSameChoices(getGedcom(), mPlaceOrder[6], gedcomStateTextField.getText());
                    if (sameChoices.length > 0) {
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(GedcomPlaceEditorPanel.class, "GedcomPlaceEditorPanel.jLabel1.text_1")); // NOI18N
        ...
        parametersButton.setText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("ancestris/modules/editors/geoplace/Bundle").getString("GedcomPlaceEditorPanel.parametersButton.text_1"), new Object[] {})); // NOI18N
        parametersButton.setToolTipText(java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("ancestris/modules/editors/geoplace/Bundle").getString("GedcomPlaceEditorPanel.parametersButton.toolTipText_1"), new Object[] {})); // NOI18N
    ...
    private void parametersButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_parametersButtonActionPerformed
        PlaceFormatEditorOptionsPanel gedcomPlaceFormatEditorPanel = new PlaceFormatEditorOptionsPanel(getGedcom());
        ...
        if (gedcomPlaceFormatEditorDialog.show() == DialogDescriptor.OK_OPTION) {
            mPlaceOrder = gedcomPlaceFormatEditorPanel.getPlaceSortOrder();
            gedcomPlaceFormatEditorPanel.commit();
        ...
        for (int index = 0; index < mPlaceOrder.length; index++) {
            if (mPlaceOrder[index] != -1) {
                if (mPlaceOrder[index] < mPlaceFormat.length && mPlaceFormat[mPlaceOrder[index]] != null) {
                    ((javax.swing.JLabel) (mGedcomFields[index][0])).setText(mPlaceFormat[mPlaceOrder[index]]);
                    List<String> jurisdictions = Arrays.asList(PropertyPlace.getAllJurisdictions(getGedcom(), mPlaceOrder[index], true));
                    if (jurisdictions != null) {
                        AutoCompleteDecorator.decorate((javax.swing.JTextField) mGedcomFields[index][1], jurisdictions, false);
    ...
    private void updatePlace(PropertyPlace place, int startIndex) {
        ...
        if (place != null) {
            ...
            Property latitude = place.getLatitude(true);
            Property longitude = place.getLongitude(true);
    ...
    /**
     * return the gedcom used.
     * This Gedcom is got from either place or root depending of context 
     * (new or existing PropertyPlace edition).
     * @return 
     */
    private Gedcom getGedcom(){
        if (mPlace!= null){
            return mPlace.getGedcom();
        } else if (mRoot != null){
            return mRoot.getGedcom();
        } else {
            return null;
        }
    }
    ...
    public void commit() {
        if (mPlaceModified) {
            ...
            if (!gedcomLatitudeTextField.getText().isEmpty() && !gedcomLongitudeTextField.getText().isEmpty()) {
                mPlace.setCoordinates(gedcomLatitudeTextField.getText(), gedcomLongitudeTextField.getText());
            }
        }
    }
}

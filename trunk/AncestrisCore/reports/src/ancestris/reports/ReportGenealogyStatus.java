...
/**
 * Report displays status of information documented for each person in the
 * tree.
 * 
 * List starts with de-cujus person and goes up the tree
 * 
 * This report expects to find Sosa tag filled in with sosa numbers (generated by the tool box for instance)
 * 
 * August 2012
 *
...
public class ReportGenealogyStatus extends Report {
    ...
    public void start(Gedcom gedcom) {
        ...
        int sosaNb = 0;   // represents the sosa number being considered
    ...
    private void headerLine() {
        ...
        println(" ");
        println("Nb " + TAB + "Sosa              " + TAB + "Gene" + TAB + "Id  " + TAB + "Media " + TAB + "Birth" + TAB + "Death" + TAB + "Marr" + TAB + "Fam " + TAB + "Marl" + SPA + "Marc" + SPA + "Div " + TAB + "Chr " + SPA + "Buri" + SPA + "Even" + SPA + "Natu" + SPA + "Adop" + SPA + "Grad " + SPA + "Immi" + TAB + "Nom                     ");
        midLine();
    }
    ...
    private String getLine(Indi indi, int index, String sosa) {
        ...
        // Number of pictures or more generally files attached
        ...
        // Graduation
        line += getEventWithAgency(sosa, indi, "INDI:GRAD", false);
        line += SPA;
    ...
    /**
     * Get sosa nb from sosa string 
     * (extracts first digital number found when going from start of string)
     */
    ...
    /**
     * Get first event found given by tag
     * Code is made of 4 characters:
     * - date of event
     * - place of event
    ...
    /**
     * Get first event found given by tag
     * (same as GetEvent but returns agency check as well
     * Code is made of 4 characters:
     * - date of event
     * - place of event
     * - agency of event
     * - source of event on 2 digits
     */
    private String getEventWithAgency(String sosa, Entity ent, String tag, boolean mandatory) {
        ...
        // agency
        Property agency = ent.getPropertyByPath(tag + ":AGNC");
        line += ((agency == null) || agency.toString().length() < 1) ? NON : OUI;
    ...
    /**
     * Get source code of an event
     * Code is made of 2 digits:
     * - source : source entity exists and has not already been attached to another event)
     * - source proof : a text or media has been found)
     * Rules:
     ...
     * - A source can only be attached once to n individual
     */
    ...
    /**
     * Get family of an individual
     * Returned string is made of several elements:
     * - Event code of MARR event
     * - family id
     * - Other "MARR" type events (MARL, MARC, DIV)
     */

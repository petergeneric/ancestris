...
public final class OLD_IndiPanel extends Editor {
    ...
    public OLD_IndiPanel() {
        ...
        tabs.addTab(NbBundle.getMessage(OLD_IndiPanel.class, "IndiPanel.tab.summary"), new JScrollPane(summary));
        tabs.addTab(NbBundle.getMessage(OLD_IndiPanel.class, "IndiPanel.tab.events"), new JScrollPane(eventsPanel));

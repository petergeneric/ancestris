...
public class RearrangeAction extends AbstractAncestrisAction {
     ...
     * Constructor
     */
    public RearrangeAction(TreeSharingTopComponent tstc) {
        this.owner = tstc;
        setImage(new javax.swing.ImageIcon(getClass().getResource("/ancestris/modules/treesharing/resources/rearrange.png")));
        setTip(NbBundle.getMessage(RearrangeAction.class, "TIP_Rearrange"));
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        owner.rearrangeWindows();
    }

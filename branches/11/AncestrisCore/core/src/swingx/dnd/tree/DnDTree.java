...
public class DnDTree extends JTree implements Autoscroll {
    ...
    private class DragHandler extends DragSourceAdapter implements DragGestureListener,
        ...
        /**
         * Start a drag with all currently selected nodes if one of them is hit
         * by the mouse event that originates the drag.
         */
        @Override
    ...
    /**
     * Create an image representation for the selection about to be dragged.
     * <br>
     * Drag images are currently not supported under Windows. On Mac OS X the
     * whole tree is used as drag image. This is why this default implementation

 ...
 * Copyright (C) 2021 Frederic Lapeyre <frederics@ancesrtis.org>
 *
...
public class ScrollPaneWidget extends JScrollPane {
     ...
     * Constructor
     */
    public ScrollPaneWidget(JComponent component) {
        super(component);
        view = null;
    }
    ...
    public class Draggin extends MouseAdapter implements MouseMotionListener {
        ...
        public void mouseDragged(MouseEvent e) {
            ...
            // Only drag pane (=move pane) if over a non entity area
            // If over an entity : skip
            if (view != null && view.getEntityAt(start, false) != null) {
                return;
            }
            
            // Else drag view and consume event to avoid dragging entity in the other mouse listener

...
/**
 * This class provides basic helper functions for managing
...
public class GridBagHelper {
    ...
    public final static int GROWFILL_HORIZONTAL = FILL_HORIZONTAL | GROW_HORIZONTAL,
    ...
    private int presetAnchor = GridBagConstraints.CENTER;
    ...
    /**
     * Sets anchor to use
     * <br>marked as deprecated as its useage is discouraged. Waiting for
     * well defined API.
     */
    @Deprecated
    public GridBagHelper setAnchor(int set) {
        if (set < 0) {
            set = GridBagConstraints.CENTER;
        }
        presetAnchor = set;
        return this;
    }
     ...
     * @param w width
     * @param h height
     * @param parm parameter via constants FILL_HORIZONTAL, FILL_VERTICAL,
     * FILL_BOTH GROW_HORIZONTAL, GROW_VERTICAL, GROW_BOTH
     * @return Added component
     */
    ...
    public Component add(Component component, int x, int y, int w, int h, int parm, Insets insets) {
        ...
        constraints.anchor = presetAnchor;
        // Set constraints
    ...
    public void addFillerH(int x, int y) {
        add(new Fill(new Dimension(0, 0)), x, y, 1, 1, GROW_HORIZONTAL);
    }

...
/**
 * Gedcom Property : ASSO Property wrapping the condition of a property having
...
public class PropertyAssociation extends PropertyXRef {
    ...
    /**
     * We're trying to give a bit more information than the default display
     * value (target.getEntity().toString()) For example: Birth Meier, Nils
     * (I008) 25 May 1970 Rendsburg
     *
    ...
    public String getDisplayValue(boolean fullDisplay) {
        ...
        final String fullName = Gedcom.getName(parent.getTag());
    ...
    /**
     * Returns a warning string that describes what happens when this property
     * would be deleted
     *
     ...
     *
     * @exception GedcomException when property has no parent property, or a
     * double husband/wife situation would be the result
     */
    ...
    public String getTargetType() {
        ...
        if (!getMetaProperty().allows("TYPE") && Grammar.GRAMMAR55.equals(getGedcom().getGrammar())) {
            return Gedcom.INDI;
        }
        // check type
        Property type = getProperty("TYPE");

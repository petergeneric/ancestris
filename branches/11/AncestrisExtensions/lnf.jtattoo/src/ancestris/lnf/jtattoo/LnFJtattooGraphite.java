 ...
 * @author lemovice
 */
@ServiceProvider(position = 305, service = LookAndFeelProvider.class)
public class LnFJtattooGraphite extends LookAndFeelProvider {

    private static final String KEY = "lnf_JtattooGraphite";

    @Override
    public String getName() {
        return "com.jtattoo.plaf.fast.GraphiteAndFeel";
    }

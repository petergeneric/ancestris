 ...
 * @author lemovice
 */
@ServiceProvider(position = 310, service = LookAndFeelProvider.class)
public class LnFJtattooNoire extends LookAndFeelProvider {

    private static final String KEY = "lnf_JtattooNoire";

...
public class TreeViewDropTarget {
    ...
    /**
     * Point d'entrée de cette classe pour ajouter la fonction DragAndDrop à 
     * une instance de TreeView.
                ...
                if (t.isDataFlavorSupported(TransferableRecord.recordFlavor)) {
                    ...
                    try {
                        if (treeView.getGedcom() != null) {
                            ...
                            MergeDialog.show(treeView, treeView.getGedcom(), entity, mergeRecord, true);

...
public class ReleveFileEgmtTest extends TestCase {
    ...
    public void testSaveFileMarriage() throws Exception {
        ...
        assertEquals("IndiPlace",               "",marriage2.getIndiBirthPlace().toString());
        assertEquals("IndiOccupation",          "",marriage2.getIndiOccupation().toString());
        assertEquals("IndiResidence",           marriage.getIndiResidence().toString(),marriage2.getIndiResidence().toString());
        assertEquals("IndiComment",             "indicomment, indioccupation, né le 01/01/1980, indiBirthplace,,,,,, conjoint: indimarriedlastnameindimarriedname indimarriedcomment, indimarriedoccupation, indiMarriedResidence,,,,,, indimarriedcomment",marriage2.getIndiComment().toString());
        ...
        assertEquals("WifePlace",               "",marriage2.getWifeBirthPlace().toString());
        ...
        assertEquals("WifeComment",             "wifecomment, wifeoccupation, né le 02/02/1982, wifeBirthplace,,,,,, conjoint: wifemarriedlastnamewifemarriedname wifemarriedcomment, wifemarriedoccupation, wifeMarriedResidence,,,,,, wifemarriedcomment",marriage2.getWifeComment().toString());
    ...
    public void testSaveFileDeath() throws Exception {
        ...
        assertEquals("IndiResidence",  death.getIndiResidence().toString(),death2.getIndiResidence().toString());
        assertEquals("IndiComment",    "indicomment, indioccupation, né le 01/01/1990, indiBirthPlace,,,,,, conjoint: indimarriedlastnameindimarriedname indimarriedcomment, indimarriedoccupation, indiMarriedResidence,,,,,, indimarriedcomment",death2.getIndiComment().toString());
    ...
    public void testSaveFileMisc() throws Exception {
        ...
        assertEquals("IndiResidence",            misc.getIndiResidence().toString(),misc2.getIndiResidence().toString());
        assertEquals("IndiComment",             "indicomment, indioccupation, né le 01/01/1980, indiBirthPlace,,,,,, conjoint: indimarriedlastnameindimarriedname indimarriedcomment, indimarriedoccupation, indiMarriedResidence,,,,,, indimarriedcomment",misc2.getIndiComment().toString());
        ...
        assertEquals("WifePlace",               "",misc2.getWifeBirthPlace().toString());
        ...
        assertEquals("WifeComment",             "wifecomment, wifeoccupation, né le 02/02/1982, wifeBirthPlace,,,,,, conjoint: wifemarriedlastnamewifemarriedname wifemarriedcomment, wifemarriedoccupation, wifeMarriedResidence,,,,,, wifemarriedcomment",misc2.getWifeComment().toString());

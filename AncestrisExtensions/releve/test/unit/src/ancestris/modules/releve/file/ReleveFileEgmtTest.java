...
public class ReleveFileEgmtTest extends TestCase {
    ...
    public void testSaveFileMarriage() throws Exception {
        ...
        assertEquals("IndiComment",             "indicomment, né le 01/01/1980, indiBirthplace,,,,,, indioccupation, conjoint: indimarriedlastname indimarriedname indimarriedcomment, indimarriedoccupation, indiMarriedResidence,,,,,, indimarriedcomment",marriage2.getIndiComment().toString());
        ...
        assertEquals("WifeComment",             "wifecomment, né le 02/02/1982, wifeBirthplace,,,,,, wifeoccupation, conjoint: wifemarriedlastname wifemarriedname wifemarriedcomment, wifemarriedoccupation, wifeMarriedResidence,,,,,, wifemarriedcomment",marriage2.getWifeComment().toString());
    ...
    public void testSaveFileDeath() throws Exception {
        ...
        assertEquals("IndiComment",    "indicomment, né le 01/01/1990, indiBirthPlace,,,,,, indioccupation, conjoint: indimarriedlastname indimarriedname indimarriedcomment, indimarriedoccupation, indiMarriedResidence,,,,,, indimarriedcomment",death2.getIndiComment().toString());
    ...
    public void testSaveFileMisc() throws Exception {
        ...
        assertEquals("IndiComment",             "indicomment, né le 01/01/1980, indiBirthPlace,,,,,, indioccupation, conjoint: indimarriedlastname indimarriedname indimarriedcomment, indimarriedoccupation, indiMarriedResidence,,,,,, indimarriedcomment",misc2.getIndiComment().toString());
        ...
        assertEquals("WifeComment",             "wifecomment, né le 02/02/1982, wifeBirthPlace,,,,,, wifeoccupation, conjoint: wifemarriedlastname wifemarriedname wifemarriedcomment, wifemarriedoccupation, wifeMarriedResidence,,,,,, wifemarriedcomment",misc2.getWifeComment().toString());

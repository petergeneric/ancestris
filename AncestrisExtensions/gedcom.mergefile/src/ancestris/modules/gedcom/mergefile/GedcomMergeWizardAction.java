...
public final class GedcomMergeWizardAction extends AbstractAncestrisAction { 
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Object o = DialogManager.create(NbBundle.getMessage(GedcomMergeWizardAction.class, "CTL_GedcomMergeAction"), panel).setMessageType(DialogManager.PLAIN_MESSAGE).setOptions(options).show();
        if (o == OKButton) {

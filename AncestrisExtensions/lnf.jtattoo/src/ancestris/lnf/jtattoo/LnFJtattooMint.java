 ...
 * @author lemovice
 */
@ServiceProvider(position = 309, service = LookAndFeelProvider.class)
public class LnFJtattooMint extends LookAndFeelProvider {

    private static final String KEY = "lnf_JtattooMint";

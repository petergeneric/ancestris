...
import static ancestris.modules.imports.generic.Bundle.grampsimport_note;
 ...
 */
@NbBundle.Messages({
    "grampsimport.note=This file has been modified by the Ancestris Genbox Import plugin."
    
})
@ServiceProvider(service = Import.class)
public class GrampsImport extends Import {
...
//        }
    ...
    protected boolean process() throws IOException {
        ...
        if ((input.getLevel() == 1) && (input.getTag().equals("GEDC"))) {
            ...
            console.println(NbBundle.getMessage(GrampsImport.class, "Import.fixDestination"));
            return true;
        }
        ...
        if ("INDI:BIRT:TYPE".equalsIgnoreCase(path.toString())) {  
            ...
            console.println(NbBundle.getMessage(GrampsImport.class, "Import.fixTagNotAllowed", input.getLine() + " ==> " + result));
            return true;
        }
    ...
    public boolean processEntities(Gedcom gedcom) {
        ...
        console.println(NbBundle.getMessage(GrampsImport.class, "Import.FixMedia"));
    ...
    public boolean processCONC(Gedcom gedcom) {
        ...
        console.println(NbBundle.getMessage(GrampsImport.class, "Import.FixCONC"));

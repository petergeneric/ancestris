...
public final class GeneanetExportOptionsPanelController extends OptionsPanelController {

    private GeneanetExportOptionsPanel panel;
    ...
    private GeneanetExportOptionsPanel getPanel() {
        if (panel == null) {
            panel = new GeneanetExportOptionsPanel(this);
        }
        return panel;
    }

...
public class PropertyTreeWidget extends DnDTree {
    ...
    /**
     * Some LnFs have the habit of fixing the row height which we don't want
     */
    ...
    /**
     * override to provide simple text value (is used by getNextMatch on key
     * presses)
     *
     */
...
//        setSelection(Collections.singletonList(added));
    ...
    private class Renderer extends DefaultTreeCellRenderer implements TreeCellRenderer {
        ...
        public Component getTreeCellRendererComponent(JTree tree, Object object, boolean sel, boolean expanded, boolean leaf, int row, boolean hasFocus) {
            ...
            Dimension retDimension = super.getPreferredSize();
            Font font = getFont();
            int fontSize = font != null ? (font.getSize() + 4) : retDimension.height;

...
public class SvgWriter extends GraphicsFileOutput {
    ...
    public void write(OutputStream out, GraphicsRenderer renderer) throws IOException {
        ...
        svgGraphics.setSVGCanvasSize(new Dimension(renderer.getImageWidth(), renderer.getImageHeight()));
        svgGraphics.getGeneratorContext().setComment("Generated by Ancestris with Batik SVG Generator");

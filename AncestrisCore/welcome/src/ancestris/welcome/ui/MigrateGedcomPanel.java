 ...
 */
class MigrateGedcomPanel extends JPanel implements Constants {

    private final Image ICON = ImageUtilities.loadImage("ancestris/welcome/resources/ico_migration.png"); //NOI18N
    
    public MigrateGedcomPanel() {
        super(new GridBagLayout());
        setOpaque(false);
        addOpenGedcom(BundleSupport.getLabel("MigrateGedcom"), BundleSupport.getLabel("MigrateGedcomDescr"));
    }

    private void addOpenGedcom(String label, String description) {
        LinkButton b = new LinkButton(label, Utils.getColor(COLOR_HEADER), true, "MigrateGedcom") { //NOI18N

            @Override
            public void actionPerformed(ActionEvent e) {
                logUsage();
                new ActionOpen().actionPerformed(e);
            }
        };

...
public class tmpMerge {
    ...
    public void start(Gedcom gedcom) {
        ...
        System.out.println("Starting Merge 1...");
        // Open log
        log = new Log(this, translate("mergeGedcom"), translate("chooseLog"), true);
        ...
        if (setting_outputFileExt.length() == 0) {
            setting_outputFileExt = "-new.ged";
        }
        ...
        if (ret) {
            ...
            JOptionPane.showMessageDialog(null, msg, "Merge", JOptionPane.INFORMATION_MESSAGE);
        } else {
            log.write(9, 0, "=", LNS, translate("Error"));
        }
    ...
    public int produceMergeHistory(Document doc, Gedcom gedcom) {
        ...
        for (Iterator it = entList.iterator(); it.hasNext();) {
            ...
            for (Iterator it2 = propList.iterator(); it2.hasNext();) {
                ...
                if ((propDate == null) || (propFile == null)) {
                    continue;
                }
    ...
    public String translate(String string, String[] stringTable) {
        return string + " " + stringTable[0];
    }

...
public class ButtonBorder implements Border {
    ...
    private ButtonBorder( boolean mouseOver ) {
        if( mouseOver ) {
            imgTopLeft = ImageUtilities.loadImage("ancestris/welcome/resources/butt-sel-top-lef.png");
            imgTopRight = ImageUtilities.loadImage("ancestris/welcome/resources/butt-sel-top-right.png");
            imgBottomLeft = ImageUtilities.loadImage("ancestris/welcome/resources/butt-sel-bott-left.png");
            imgBottomRight = ImageUtilities.loadImage("ancestris/welcome/resources/butt-sel-bott-right.png");
            imgLeft = ImageUtilities.loadImage("ancestris/welcome/resources/butt-sel-side-left.png");
            imgRight = ImageUtilities.loadImage("ancestris/welcome/resources/butt-sel-side-right.png");
            imgTop = ImageUtilities.loadImage("ancestris/welcome/resources/butt-sel-top.png");
            imgBottom = ImageUtilities.loadImage("ancestris/welcome/resources/butt-sel-bottom.png");
            imgCenter = ImageUtilities.loadImage("ancestris/welcome/resources/butt-sel-center.png");
        } else {
            imgTopLeft = ImageUtilities.loadImage("ancestris/welcome/resources/butt-top-lef.png");
            imgTopRight = ImageUtilities.loadImage("ancestris/welcome/resources/butt-top-right.png");
            imgBottomLeft = ImageUtilities.loadImage("ancestris/welcome/resources/butt-bott-left.png");
            imgBottomRight = ImageUtilities.loadImage("ancestris/welcome/resources/butt-bott-right.png");
            imgLeft = ImageUtilities.loadImage("ancestris/welcome/resources/butt-side-left.png");
            imgRight = ImageUtilities.loadImage("ancestris/welcome/resources/butt-side-right.png");
            imgTop = ImageUtilities.loadImage("ancestris/welcome/resources/butt-top.png");
            imgBottom = ImageUtilities.loadImage("ancestris/welcome/resources/butt-bottom.png");
            imgCenter = ImageUtilities.loadImage("ancestris/welcome/resources/butt-center.png");
        }
    }

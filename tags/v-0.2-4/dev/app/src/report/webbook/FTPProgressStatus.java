 ...
 */
  public class FTPProgressStatus {
    ...
    public FTPProgressStatus(ReportWebBook report, String pDlgTitle, String pMessage, String pStatus, int pTotal, String pButton, FTPLog log) {
    ...
    public void interruption() {
       String str = report.translate("upload_userCancelled");
       setStatus(str);
       report.println(str);
       log.write(str);
       close();
    ...
    private void setValue(int value) {
       ...
       int percent = (int)(increment*100 / total);

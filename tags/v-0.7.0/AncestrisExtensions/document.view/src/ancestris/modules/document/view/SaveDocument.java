...
public class SaveDocument {
    ...
    File saveFile = null;
    final FileNameExtensionFilter htmlFilter = new FileNameExtensionFilter(NbBundle.getMessage(this.getClass(), "SaveDocument.fileType.html"), "html");
    final FileNameExtensionFilter pdfFilter = new FileNameExtensionFilter(NbBundle.getMessage(this.getClass(), "SaveDocument.fileType.pdf"), "pdf");
    final FileNameExtensionFilter csvFilter = new FileNameExtensionFilter(NbBundle.getMessage(this.getClass(), "SaveDocument.fileType.csv"), "csv");
    private JFileChooser fileChooser = new JFileChooser() {
        ...
        public void approveSelection() {
            ...
            if (f.exists() && getDialogType() == SAVE_DIALOG) {
                int result = JOptionPane.showConfirmDialog(this, NbBundle.getMessage(this.getClass(), "SaveDocument.Overwrite.Text"), NbBundle.getMessage(this.getClass(), "SaveDocument.Overwrite.Title"), JOptionPane.YES_NO_CANCEL_OPTION);
                switch (result) {
    ...
    public SaveDocument(genj.fo.Document doc, String fileName) {
        document = doc;

...
class Tutorials extends JPanel implements Constants {
    ...
    private void buildContent() {
        ...
        WebLink link = new WebLink(BundleSupport.getLabel("AllOnlineDocs"), BundleSupport.getURL("AllOnlineDocs"), Utils.getColor(Constants.COLOR_SECTION_HEADER), false); //NOI18N
    ...
    private Action extractAction( DataObject dob ) {
        ...
        if( null != instCookie && instCookie.instanceOf( Action.class ) ) {
            try {
                ...
                Logger.getLogger(Tutorials.class.getName()).log( Level.INFO, null, e );
            }
        }
        return null;
    }
